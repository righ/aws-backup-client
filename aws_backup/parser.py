...
parser.add_argument("--aws-time-diff", type=TypeDelta(), help="time difference of aws host")
parser.add_argument("--client-time-diff", type=TypeDelta(), help="time difference of client host")
parser.add_argument("--client-time-format", help="time format as part of name", default='%Y-%m-%dT%H-%M')
